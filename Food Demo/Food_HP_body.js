...
(function () {
  ...
  this.buildHTML = function () {
    this.buildCarouselBanner("carousal-banner");
    this.buildCarousel("carousal-content", CaruselData);
    this.buildShippingBaner("shipping-baner");
  ...
  this.buildCarouselBanner = function (slideid) {
  ...
  this.buildCarousel = function (slideid, CaruselData) {
    ...
    <div class="gard-overlay">
        ...
        <button id="shop_now" class="shop_now" onclick="customHomepage.setUUIDandNav('${value.deepLink}')" >${value.buttonText}</button>
  ...
  this.switchSlide = function (isCurrent, next = true) {
    ...
    idx =
      +sessionStorage.getItem("savedIDX") < this.CaruselData.length
    ...
    <div class="gard-overlay">
        <div class="slide-text">
            <p class="sub_title">${value.subTitle}</p>
            <p class="title">${value.title}</p>
            <p class="desc">${value.description}</p>
        </div>
        <button id="shop_now" class="shop_now" onclick="customHomepage.setUUIDandNav('${value.deepLink}')" >${value.buttonText}</button>
