...
const LeftMenu = [
  ...
  },
  {
    ...
    action: "setUUIDandNav",
    deepLink:
      "Transactions/scope_items/{{UUID}}?CurrentTab=%22%7B%5C%22JsonFilter%5C%22:%5C%22023bad44-a6d3-435b-928d-bab0a41b4dc6%5C%22%7D%22",
  },

  {
    ...
    action: "setUUIDandNav",
    deepLink:
      "Transactions/scope_items/{{UUID}}?CurrentTab=%22%7B%5C%22JsonFilter%5C%22:%5C%22696718b2-3431-4aad-b23a-8a6d7c824ef0%5C%22%7D%22",
  },
  {
    catalog: "ALL",
    transaction: "B2B Order",
    ...
    action: "setUUIDandNav",
    deepLink:
      "Transactions/scope_items/{{UUID}}?CurrentTab=%22%7B%5C%22JsonFilter%5C%22:%5C%222a7c613e-1e67-4497-af60-ae8a6633487a%5C%22%7D%22",
  },
  {
    catalog: "ALL",
...
<div class="dropdown">
  ...
  // ---
  // Left menu
  this.HeaderLeftMenu = function (LeftMenu) {
    let htmlStr = "";
    for (const item of LeftMenu) {
      ...
      htmlStr += `<${htmlTag}  class="${classMenu}" onclick="${customHeader.handleAction(
        item,
        "customHeader"
      )}">${item.title}</${htmlTag}>`;
    }
    if (document.getElementById("menuDropdown")) {
      document.getElementById(
        "menuDropdown"
      ).innerHTML += `<ul class="shown-on-mobile">${htmlStr}</ul><hr class="shown-on-mobile">`;
    }
