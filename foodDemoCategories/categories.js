customFunction.buildCategories = function (slideid) {
  ...
  categoriesImgHTML += `
          <div class="box box1">
              ...
              <div class="box box2">
                 <div class="item4" 
                 onclick="customHcustomFunctionomepage.setUUIDandNav('${midle_top_left_img.deepLink}')"
                 style="background-image: url(${midle_top_left_img.image});">
                     <div class="overlay">${midle_top_left_img.title}</div>
                 </div>
                 <div class="item5"
                 onclick="customFunction.setUUIDandNav('${midle_bottom_left_img.deepLink}')"
                  style="background-image: url(${midle_bottom_left_img.image});">
                   <div class="overlay">${midle_bottom_left_img.title}</div> 
                 </div>
                  <div class="item6"
                  onclick="customFunction.setUUIDandNav('${midle_right_img.deepLink}')"
              ...
              <div class="box3">
                  <div class="item7"
                  onclick="customFunction.setUUIDandNav('${right_top_img.deepLink}')"
                  style="background-image: url(${right_top_img.image});">
                      <div class="overlay">${right_top_img.title}</div>
                  </div>
                  <div class="item8"
                  onclick="customFunction.setUUIDandNav('${right_bottom_img.deepLink}')"
